...
public trait ComponentRegistrar {
    companion object {
        public val PLUGIN_COMPONENT_REGISTRARS: CompilerConfigurationSinkKey.ListKey<ComponentRegistrar> =
                CompilerConfigurationSinkKey.createList("plugin component registrars")
    }
