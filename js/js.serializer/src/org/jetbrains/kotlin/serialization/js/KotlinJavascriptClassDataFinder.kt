...
public class KotlinJavascriptClassDataFinder(
    ...
    override fun findClassData(classId: ClassId): ClassData? {
        ...
        val stream = loadResource(KotlinJavascriptSerializationUtil.getClassMetadataPath(classId)) ?: return null

        val classProto = ProtoBuf.Class.parseFrom(stream, KotlinJavascriptSerializationUtil.EXTENSION_REGISTRY)
        val nameResolver =
                (packageFragment as? KotlinJavascriptPackageFragment ?: error("Not a kotlin/javascript package fragment: $packageFragment")).nameResolver
